...
public class CartmanagementRestServiceImpl implements CartmanagementRestService {
  ...
  @Override
  public CartEto getCartByUserName(String userName) {

    return this.cartmanagement.findCartByUserName(userName);
  }
  ...
  @Override
  public CartEto updateCart(CartEto cart, long id) {

    return this.cartmanagement.updateCart(cart, id);
  }
