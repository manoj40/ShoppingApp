...
public interface CartmanagementRestService {
  ...
  /**
   * Delegates to {@link Cartmanagement#find}.
   *
   * @param id of the {@link CartEto} to find
  ...
  /**
   * Delegates to {@link Cartmanagement#findCartByUserId}.
   *
   * @param id the ID of the {@link CartEto}
   * @return the {@link CartEto}
   */
  @GET
  @Path("/cart/user/{userName}/")
  public CartEto getCartByUserName(@PathParam("userName") String userName);

  /**
   * Delegates to {@link Cartmanagement#updateCart}.
   *
   * @param the {@link CartEto} object containing the updates to be made
   * @param id to be updated
   * @return the recently updated {@link CartEto}
   */
  @PUT
  @Path("/cart/{id}/")
  public CartEto updateCart(CartEto cart, @PathParam("id") long id);
